...
console.log({
  userInfo: os__default["default"].userInfo().username,
  geteuid: typeof process.geteuid === "function" ? process.geteuid() : os__default["default"].userInfo().username
});
console.log({
  userInfo: os__default["default"].userInfo().username,
  geteuid: typeof process.geteuid === "function" ? process.geteuid() : void 0
});
const cacheDirectory = path__default["default"].join(
  // Write permissions by anyone
  tmpdir,
  // Write permissions only by current user
  `tsx-${os__default["default"].userInfo().uid}`
);
console.log({
  cacheDirectory
});
