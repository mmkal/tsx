...
var js = require('es-module-lexer/js');
var fs = require('fs');
...
const parseEsm = (code) => wasmParserInitialized ? esModuleLexer.parse(code) : js.parse(code);
...
const userId = geteuid ? geteuid() : os__default["default"].userInfo().username;
